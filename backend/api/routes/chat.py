...
Be concise and direct. When you have enough information to create a complete summary, say \"✅ I'm ready to summarize\"."""
            ...
            session_data = {
                ...
                #"is_ready": "✅ I'm ready to summarize" in response,
                "is_ready": True, #for tesitng, revert to prod
...
Be brief and direct. If we have enough information for a complete summary, say \"✅ I'm ready to summarize\".""",
            ...
            session_data.update({
                ...
                "latest_response": response,
                #"is_ready": "✅ I'm ready to summarize" in response
                "is_ready": True # For testing, revert for prod
            })
        ...
        return ChatResponse(
            ...
            done=True #Forced for testing, change while testing for prod
